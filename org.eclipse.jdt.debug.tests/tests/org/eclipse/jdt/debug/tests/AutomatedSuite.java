...
import org.eclipse.jdt.debug.tests.breakpoints.DependencyBreakpointsTests;
...
import org.eclipse.jdt.debug.tests.launching.JavaClasspathTabTests;
...
public class AutomatedSuite extends DebugSuite {
	...
	//Launching tests
		...
		addTest(new TestSuite(JavaClasspathTabTests.class));
	...
	//add the complete eval suite
		...
		addTest(new TestSuite(DependencyBreakpointsTests.class));
